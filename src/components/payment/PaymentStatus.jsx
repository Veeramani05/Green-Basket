        ...
        <Container>
          <Row>
            <Col md={7} className="d-flex justify-content-center align-content-center text-center flex-column">
              <img src={state.transactionStatus !== 'S' ? orderFailed : orderSuccess} alt="Success Info" className="img-fluid" style={{ maxWidth: "7rem", margin: "2rem auto" }} />
              {state.transactionStatus !== 'S' ? <p className="text-danger" style={{ fontSize: "2rem", fontWeight: 500 }}>Order was Canceled</p> : <p className="text-success" style={{ fontSize: "2rem", fontWeight: 500 }}>Order Success ...</p>}
            </Col>
            <Col md={5}>
              {this.paymentSummery()}
            </Col>
