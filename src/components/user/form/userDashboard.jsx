...
class UserDashboard extends PureComponent {
  ...
  addtoCart = async (data) => {
    const { productName, productId, quantity, productUomId, productQuantity, categoryId } = data;
  ...
  addtoWishlist = async (data) => {
    const { productName, productId, quantity, productQuantity, productUomId } = data;
    let postData = {
      "userId": this.state.uid,
      "productId": productId,
      "quantity": quantity || productQuantity,
