...
class SignUp extends PureComponent {
  ...
  /**
   * Redirect the function when user submit the form
   */
  onSubmit = async () => {
  ...
  /**
   * Send the OTP to perticular user 
   */
  otpSend = async () => {
    try {
  ...
  /**
   * To store the user info to server
   */
  signUp = async () => {
    const data = this.formApi.getState().values;
  ...
  /**
   * Check the user availability in server
   */
